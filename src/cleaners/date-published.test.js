...
describe('cleanDatePublished(dateString)', () => {
  ...
  it('returns null if date is invalid', () => {
    ...
    expect(datePublished).toEqual(null);
  });
  ...
  it('handles timezones', () => {
    ...
    expect(datePublished).toEqual('2016-11-29T13:18:00.000Z');
  });
  ...
  it('accepts a custom date format', () => {
    ...
    expect(datePublished).toEqual('2015-08-03T16:45:00.000Z');
  });
  ...
  it('can handle dates formatted as "[just|right] now"', () => {
    ...
    expect(newDate1).toEqual(expectedDate1);
    ...
    expect(newDate2).toEqual(expectedDate2);
    ...
    expect(newDate3).toEqual(expectedDate3);
  });
...
describe('cleanDateString(dateString)', () => {
  it('removes "published" text from an datePublished string', () => {
    ...
    expect(datePublished).toEqual('1/1/2020');
  });
  ...
  it('puts a space b/w a time and am/pm', () => {
    ...
    expect(date1).toEqual('1/1/2020 8:30 am');

    const date2 = cleanDateString('8:30PM 1/1/2020');
    expect(date2).toEqual('8:30 PM   1/1/2020');
  });
  ...
  it('can handle some tough timestamps', () => {
    ...
    expect(date1).toEqual('15 Apr 2016 10:59');
  });
  ...
  it('massages the T out', () => {
    ...
    expect(date1).toEqual('2016 11 22 08:57 -500');
  });
});
